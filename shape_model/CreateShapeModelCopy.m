...
function y = myScript()
    ...
    ShapeData.landmark_unwant = [];
    disp("imgSizeCNN")
    disp(imgSizeCNN)
    ShapeData.imgSizeCNN = imgSizeCNN;
    save([shapeModelFolder 'ShapeModel1.mat'],'ShapeData');
end
...
function y = myScript()
    ...
    %% Set options
    % folder containing the training landmarks
    landmarkFolder='../data/landmarsk_from_ct/';
    % file containing list of shape images to use
    shapeListFile = '../data/list_train.txt';
    % folder storing the shape model txt and mat file
    shapeModelFolder='./shape_model/';
    ...
    ShapeData.imgSizeCNN = imgSizeCNN;
    save([shapeModelFolder 'ShapeModelTest10.mat'],'ShapeData');
    y = ShapeData
end
